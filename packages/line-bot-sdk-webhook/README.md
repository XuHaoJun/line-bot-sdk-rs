# Rust API client for line-bot-sdk-webhook
...
Put the package under your project folder in a directory named `line-bot-sdk-webhook` and add the following to `Cargo.toml` under `[dependencies]`:
