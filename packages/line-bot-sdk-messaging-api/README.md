...
*MessagingApiApi* | [**close_coupon**](docs/MessagingApiApi.md#close_coupon) | **PUT** /v2/bot/coupon/{couponId}/close | 
*MessagingApiApi* | [**create_coupon**](docs/MessagingApiApi.md#create_coupon) | **POST** /v2/bot/coupon | 
...
*MessagingApiApi* | [**get_coupon_detail**](docs/MessagingApiApi.md#get_coupon_detail) | **GET** /v2/bot/coupon/{couponId} | 
...
## Documentation For Models
 ...
 - [AcquisitionConditionRequest](docs/AcquisitionConditionRequest.md)
 - [AcquisitionConditionResponse](docs/AcquisitionConditionResponse.md)
 ...
 - [CashBackFixedPriceInfoRequest](docs/CashBackFixedPriceInfoRequest.md)
 - [CashBackFixedPriceInfoResponse](docs/CashBackFixedPriceInfoResponse.md)
 - [CashBackPercentagePriceInfoRequest](docs/CashBackPercentagePriceInfoRequest.md)
 - [CashBackPercentagePriceInfoResponse](docs/CashBackPercentagePriceInfoResponse.md)
 - [CashBackPriceInfoRequest](docs/CashBackPriceInfoRequest.md)
 - [CashBackPriceInfoResponse](docs/CashBackPriceInfoResponse.md)
 ...
 - [CouponCashBackRewardRequest](docs/CouponCashBackRewardRequest.md)
 - [CouponCashBackRewardResponse](docs/CouponCashBackRewardResponse.md)
 - [CouponCreateRequest](docs/CouponCreateRequest.md)
 - [CouponCreateResponse](docs/CouponCreateResponse.md)
 - [CouponDiscountRewardRequest](docs/CouponDiscountRewardRequest.md)
 - [CouponDiscountRewardResponse](docs/CouponDiscountRewardResponse.md)
 - [CouponFreeRewardRequest](docs/CouponFreeRewardRequest.md)
 - [CouponFreeRewardResponse](docs/CouponFreeRewardResponse.md)
 - [CouponGiftRewardRequest](docs/CouponGiftRewardRequest.md)
 - [CouponGiftRewardResponse](docs/CouponGiftRewardResponse.md)
 - [CouponListResponse](docs/CouponListResponse.md)
 - [CouponMessage](docs/CouponMessage.md)
 - [CouponOthersRewardRequest](docs/CouponOthersRewardRequest.md)
 - [CouponOthersRewardResponse](docs/CouponOthersRewardResponse.md)
 - [CouponResponse](docs/CouponResponse.md)
 - [CouponRewardRequest](docs/CouponRewardRequest.md)
 - [CouponRewardResponse](docs/CouponRewardResponse.md)
 ...
 - [DiscountExplicitPriceInfoRequest](docs/DiscountExplicitPriceInfoRequest.md)
 - [DiscountExplicitPriceInfoResponse](docs/DiscountExplicitPriceInfoResponse.md)
 - [DiscountFixedPriceInfoRequest](docs/DiscountFixedPriceInfoRequest.md)
 - [DiscountFixedPriceInfoResponse](docs/DiscountFixedPriceInfoResponse.md)
 - [DiscountPercentagePriceInfoRequest](docs/DiscountPercentagePriceInfoRequest.md)
 - [DiscountPercentagePriceInfoResponse](docs/DiscountPercentagePriceInfoResponse.md)
 - [DiscountPriceInfoRequest](docs/DiscountPriceInfoRequest.md)
 - [DiscountPriceInfoResponse](docs/DiscountPriceInfoResponse.md)
 - [Emoji](docs/Emoji.md)
 ...
 - [MessagingApiPagerCouponListResponse](docs/MessagingApiPagerCouponListResponse.md)
 ...
 - [NormalAcquisitionConditionRequest](docs/NormalAcquisitionConditionRequest.md)
 - [NormalAcquisitionConditionResponse](docs/NormalAcquisitionConditionResponse.md)
 ...
 - [ReferralAcquisitionConditionResponse](docs/ReferralAcquisitionConditionResponse.md)
