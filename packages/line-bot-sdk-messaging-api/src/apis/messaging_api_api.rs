...
pub async fn broadcast(configuration: &configuration::Configuration, broadcast_request: models::BroadcastRequest, x_line_retry_key: Option<&str>) -> Result<serde_json::Value, Error<BroadcastError>> {
...
pub async fn cancel_default_rich_menu(configuration: &configuration::Configuration, ) -> Result<(), Error<CancelDefaultRichMenuError>> {
...
/// Close coupon
pub async fn close_coupon(configuration: &configuration::Configuration, coupon_id: &str) -> Result<(), Error<CloseCouponError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_coupon_id = coupon_id;

    let uri_str = format!("{}/v2/bot/coupon/{couponId}/close", configuration.base_path, couponId=crate::apis::urlencode(p_path_coupon_id));
...
pub async fn create_coupon(configuration: &configuration::Configuration, coupon_create_request: Option<models::CouponCreateRequest>) -> Result<models::CouponCreateResponse, Error<CreateCouponError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Create rich menu
pub async fn create_rich_menu(configuration: &configuration::Configuration, rich_menu_request: models::RichMenuRequest) -> Result<models::RichMenuIdResponse, Error<CreateRichMenuError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn create_rich_menu_alias(configuration: &configuration::Configuration, create_rich_menu_alias_request: models::CreateRichMenuAliasRequest) -> Result<(), Error<CreateRichMenuAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Deletes a rich menu.
pub async fn delete_rich_menu(configuration: &configuration::Configuration, rich_menu_id: &str) -> Result<(), Error<DeleteRichMenuError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_id = rich_menu_id;

    let uri_str = format!("{}/v2/bot/richmenu/{richMenuId}", configuration.base_path, richMenuId=crate::apis::urlencode(p_path_rich_menu_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_rich_menu_alias(configuration: &configuration::Configuration, rich_menu_alias_id: &str) -> Result<(), Error<DeleteRichMenuAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_alias_id = rich_menu_alias_id;

    let uri_str = format!("{}/v2/bot/richmenu/alias/{richMenuAliasId}", configuration.base_path, richMenuAliasId=crate::apis::urlencode(p_path_rich_menu_alias_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_aggregation_unit_name_list(configuration: &configuration::Configuration, limit: Option<&str>, start: Option<&str>) -> Result<models::GetAggregationUnitNameListResponse, Error<GetAggregationUnitNameListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_start = start;

    let uri_str = format!("{}/v2/bot/message/aggregation/list", configuration.base_path);
...
pub async fn get_aggregation_unit_usage(configuration: &configuration::Configuration, ) -> Result<models::GetAggregationUnitUsageResponse, Error<GetAggregationUnitUsageError>> {

    let uri_str = format!("{}/v2/bot/message/aggregation/info", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Get bot info
pub async fn get_bot_info(configuration: &configuration::Configuration, ) -> Result<models::BotInfoResponse, Error<GetBotInfoError>> {
...
/// Get coupon detail
pub async fn get_coupon_detail(configuration: &configuration::Configuration, coupon_id: &str) -> Result<models::CouponResponse, Error<GetCouponDetailError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_coupon_id = coupon_id;

    let uri_str = format!("{}/v2/bot/coupon/{couponId}", configuration.base_path, couponId=crate::apis::urlencode(p_path_coupon_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_default_rich_menu_id(configuration: &configuration::Configuration, ) -> Result<models::RichMenuIdResponse, Error<GetDefaultRichMenuIdError>> {
...
pub async fn get_followers(configuration: &configuration::Configuration, start: Option<&str>, limit: Option<i32>) -> Result<models::GetFollowersResponse, Error<GetFollowersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_start = start;
    let p_query_limit = limit;
...
pub async fn get_group_member_count(configuration: &configuration::Configuration, group_id: &str) -> Result<models::GroupMemberCountResponse, Error<GetGroupMemberCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_id = group_id;

    let uri_str = format!("{}/v2/bot/group/{groupId}/members/count", configuration.base_path, groupId=crate::apis::urlencode(p_path_group_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_group_member_profile(configuration: &configuration::Configuration, group_id: &str, user_id: &str) -> Result<models::GroupUserProfileResponse, Error<GetGroupMemberProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_id = group_id;
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/group/{groupId}/member/{userId}", configuration.base_path, groupId=crate::apis::urlencode(p_path_group_id), userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_group_members_ids(configuration: &configuration::Configuration, group_id: &str, start: Option<&str>) -> Result<models::MembersIdsResponse, Error<GetGroupMembersIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_id = group_id;
    let p_query_start = start;

    let uri_str = format!("{}/v2/bot/group/{groupId}/members/ids", configuration.base_path, groupId=crate::apis::urlencode(p_path_group_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_group_summary(configuration: &configuration::Configuration, group_id: &str) -> Result<models::GroupSummaryResponse, Error<GetGroupSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_id = group_id;

    let uri_str = format!("{}/v2/bot/group/{groupId}/summary", configuration.base_path, groupId=crate::apis::urlencode(p_path_group_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_joined_membership_users(configuration: &configuration::Configuration, membership_id: i32, start: Option<&str>, limit: Option<i32>) -> Result<models::GetJoinedMembershipUsersResponse, Error<GetJoinedMembershipUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_membership_id = membership_id;
    let p_query_start = start;
    let p_query_limit = limit;

    let uri_str = format!("{}/v2/bot/membership/{membershipId}/users/ids", configuration.base_path, membershipId=p_path_membership_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_membership_list(configuration: &configuration::Configuration, ) -> Result<models::MembershipListResponse, Error<GetMembershipListError>> {
...
pub async fn get_membership_subscription(configuration: &configuration::Configuration, user_id: &str) -> Result<models::GetMembershipSubscriptionResponse, Error<GetMembershipSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/membership/subscription/{userId}", configuration.base_path, userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_message_quota(configuration: &configuration::Configuration, ) -> Result<models::MessageQuotaResponse, Error<GetMessageQuotaError>> {
...
pub async fn get_message_quota_consumption(configuration: &configuration::Configuration, ) -> Result<models::QuotaConsumptionResponse, Error<GetMessageQuotaConsumptionError>> {

    let uri_str = format!("{}/v2/bot/message/quota/consumption", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_narrowcast_progress(configuration: &configuration::Configuration, request_id: &str) -> Result<models::NarrowcastProgressResponse, Error<GetNarrowcastProgressError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_request_id = request_id;

    let uri_str = format!("{}/v2/bot/message/progress/narrowcast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_number_of_sent_broadcast_messages(configuration: &configuration::Configuration, date: &str) -> Result<models::NumberOfMessagesResponse, Error<GetNumberOfSentBroadcastMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;

    let uri_str = format!("{}/v2/bot/message/delivery/broadcast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetNumberOfSentBroadcastMessagesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get number of sent multicast messages
pub async fn get_number_of_sent_multicast_messages(configuration: &configuration::Configuration, date: &str) -> Result<models::NumberOfMessagesResponse, Error<GetNumberOfSentMulticastMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;

    let uri_str = format!("{}/v2/bot/message/delivery/multicast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetNumberOfSentMulticastMessagesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get number of sent push messages
pub async fn get_number_of_sent_push_messages(configuration: &configuration::Configuration, date: &str) -> Result<models::NumberOfMessagesResponse, Error<GetNumberOfSentPushMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;
...
pub async fn get_number_of_sent_reply_messages(configuration: &configuration::Configuration, date: &str) -> Result<models::NumberOfMessagesResponse, Error<GetNumberOfSentReplyMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;
...
pub async fn get_pnp_message_statistics(configuration: &configuration::Configuration, date: &str) -> Result<models::NumberOfMessagesResponse, Error<GetPnpMessageStatisticsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;
...
/// Get profile
pub async fn get_profile(configuration: &configuration::Configuration, user_id: &str) -> Result<models::UserProfileResponse, Error<GetProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/profile/{userId}", configuration.base_path, userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_rich_menu(configuration: &configuration::Configuration, rich_menu_id: &str) -> Result<models::RichMenuResponse, Error<GetRichMenuError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_id = rich_menu_id;
...
pub async fn get_rich_menu_alias(configuration: &configuration::Configuration, rich_menu_alias_id: &str) -> Result<models::RichMenuAliasResponse, Error<GetRichMenuAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_alias_id = rich_menu_alias_id;
...
pub async fn get_rich_menu_alias_list(configuration: &configuration::Configuration, ) -> Result<models::RichMenuAliasListResponse, Error<GetRichMenuAliasListError>> {
...
pub async fn get_rich_menu_batch_progress(configuration: &configuration::Configuration, request_id: &str) -> Result<models::RichMenuBatchProgressResponse, Error<GetRichMenuBatchProgressError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_request_id = request_id;
...
pub async fn get_rich_menu_id_of_user(configuration: &configuration::Configuration, user_id: &str) -> Result<models::RichMenuIdResponse, Error<GetRichMenuIdOfUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/user/{userId}/richmenu", configuration.base_path, userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Get rich menu list
pub async fn get_rich_menu_list(configuration: &configuration::Configuration, ) -> Result<models::RichMenuListResponse, Error<GetRichMenuListError>> {
...
pub async fn get_room_member_count(configuration: &configuration::Configuration, room_id: &str) -> Result<models::RoomMemberCountResponse, Error<GetRoomMemberCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_room_id = room_id;

    let uri_str = format!("{}/v2/bot/room/{roomId}/members/count", configuration.base_path, roomId=crate::apis::urlencode(p_path_room_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_room_member_profile(configuration: &configuration::Configuration, room_id: &str, user_id: &str) -> Result<models::RoomUserProfileResponse, Error<GetRoomMemberProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_room_id = room_id;
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/room/{roomId}/member/{userId}", configuration.base_path, roomId=crate::apis::urlencode(p_path_room_id), userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_room_members_ids(configuration: &configuration::Configuration, room_id: &str, start: Option<&str>) -> Result<models::MembersIdsResponse, Error<GetRoomMembersIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_room_id = room_id;
    let p_query_start = start;

    let uri_str = format!("{}/v2/bot/room/{roomId}/members/ids", configuration.base_path, roomId=crate::apis::urlencode(p_path_room_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_webhook_endpoint(configuration: &configuration::Configuration, ) -> Result<models::GetWebhookEndpointResponse, Error<GetWebhookEndpointError>> {

    let uri_str = format!("{}/v2/bot/channel/webhook/endpoint", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Issue link token
pub async fn issue_link_token(configuration: &configuration::Configuration, user_id: &str) -> Result<models::IssueLinkTokenResponse, Error<IssueLinkTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;

    let uri_str = format!("{}/v2/bot/user/{userId}/linkToken", configuration.base_path, userId=crate::apis::urlencode(p_path_user_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn leave_group(configuration: &configuration::Configuration, group_id: &str) -> Result<(), Error<LeaveGroupError>> {
    ...
    let uri_str = format!("{}/v2/bot/group/{groupId}/leave", configuration.base_path, groupId=crate::apis::urlencode(p_path_group_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn leave_room(configuration: &configuration::Configuration, room_id: &str) -> Result<(), Error<LeaveRoomError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_room_id = room_id;

    let uri_str = format!("{}/v2/bot/room/{roomId}/leave", configuration.base_path, roomId=crate::apis::urlencode(p_path_room_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn link_rich_menu_id_to_user(configuration: &configuration::Configuration, user_id: &str, rich_menu_id: &str) -> Result<(), Error<LinkRichMenuIdToUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;
    let p_path_rich_menu_id = rich_menu_id;

    let uri_str = format!("{}/v2/bot/user/{userId}/richmenu/{richMenuId}", configuration.base_path, userId=crate::apis::urlencode(p_path_user_id), richMenuId=crate::apis::urlencode(p_path_rich_menu_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn link_rich_menu_id_to_users(configuration: &configuration::Configuration, rich_menu_bulk_link_request: models::RichMenuBulkLinkRequest) -> Result<(), Error<LinkRichMenuIdToUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn list_coupon(configuration: &configuration::Configuration, status: Option<Vec<String>>, start: Option<&str>, limit: Option<i32>) -> Result<models::MessagingApiPagerCouponListResponse, Error<ListCouponError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn mark_messages_as_read(configuration: &configuration::Configuration, mark_messages_as_read_request: models::MarkMessagesAsReadRequest) -> Result<(), Error<MarkMessagesAsReadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn multicast(configuration: &configuration::Configuration, multicast_request: models::MulticastRequest, x_line_retry_key: Option<&str>) -> Result<serde_json::Value, Error<MulticastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn narrowcast(configuration: &configuration::Configuration, narrowcast_request: models::NarrowcastRequest, x_line_retry_key: Option<&str>) -> Result<serde_json::Value, Error<NarrowcastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn push_message(configuration: &configuration::Configuration, push_message_request: models::PushMessageRequest, x_line_retry_key: Option<&str>) -> Result<models::PushMessageResponse, Error<PushMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn push_messages_by_phone(configuration: &configuration::Configuration, pnp_messages_request: models::PnpMessagesRequest, x_line_delivery_tag: Option<&str>) -> Result<(), Error<PushMessagesByPhoneError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Send reply message
pub async fn reply_message(configuration: &configuration::Configuration, reply_message_request: models::ReplyMessageRequest) -> Result<models::ReplyMessageResponse, Error<ReplyMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn rich_menu_batch(configuration: &configuration::Configuration, rich_menu_batch_request: models::RichMenuBatchRequest) -> Result<(), Error<RichMenuBatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn set_default_rich_menu(configuration: &configuration::Configuration, rich_menu_id: &str) -> Result<(), Error<SetDefaultRichMenuError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_id = rich_menu_id;

    let uri_str = format!("{}/v2/bot/user/all/richmenu/{richMenuId}", configuration.base_path, richMenuId=crate::apis::urlencode(p_path_rich_menu_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn set_webhook_endpoint(configuration: &configuration::Configuration, set_webhook_endpoint_request: models::SetWebhookEndpointRequest) -> Result<(), Error<SetWebhookEndpointError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn show_loading_animation(configuration: &configuration::Configuration, show_loading_animation_request: models::ShowLoadingAnimationRequest) -> Result<serde_json::Value, Error<ShowLoadingAnimationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn test_webhook_endpoint(configuration: &configuration::Configuration, test_webhook_endpoint_request: Option<models::TestWebhookEndpointRequest>) -> Result<models::TestWebhookEndpointResponse, Error<TestWebhookEndpointError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn unlink_rich_menu_id_from_user(configuration: &configuration::Configuration, user_id: &str) -> Result<(), Error<UnlinkRichMenuIdFromUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user_id = user_id;
...
pub async fn unlink_rich_menu_id_from_users(configuration: &configuration::Configuration, rich_menu_bulk_unlink_request: models::RichMenuBulkUnlinkRequest) -> Result<(), Error<UnlinkRichMenuIdFromUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_rich_menu_alias(configuration: &configuration::Configuration, rich_menu_alias_id: &str, update_rich_menu_alias_request: models::UpdateRichMenuAliasRequest) -> Result<(), Error<UpdateRichMenuAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_rich_menu_alias_id = rich_menu_alias_id;
...
pub async fn validate_broadcast(configuration: &configuration::Configuration, validate_message_request: models::ValidateMessageRequest) -> Result<(), Error<ValidateBroadcastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_message_request = validate_message_request;

    let uri_str = format!("{}/v2/bot/message/validate/broadcast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn validate_multicast(configuration: &configuration::Configuration, validate_message_request: models::ValidateMessageRequest) -> Result<(), Error<ValidateMulticastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_message_request = validate_message_request;

    let uri_str = format!("{}/v2/bot/message/validate/multicast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn validate_narrowcast(configuration: &configuration::Configuration, validate_message_request: models::ValidateMessageRequest) -> Result<(), Error<ValidateNarrowcastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_message_request = validate_message_request;

    let uri_str = format!("{}/v2/bot/message/validate/narrowcast", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn validate_push(configuration: &configuration::Configuration, validate_message_request: models::ValidateMessageRequest) -> Result<(), Error<ValidatePushError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_message_request = validate_message_request;
...
pub async fn validate_reply(configuration: &configuration::Configuration, validate_message_request: models::ValidateMessageRequest) -> Result<(), Error<ValidateReplyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_validate_message_request = validate_message_request;
...
pub async fn validate_rich_menu_batch_request(configuration: &configuration::Configuration, rich_menu_batch_request: models::RichMenuBatchRequest) -> Result<(), Error<ValidateRichMenuBatchRequestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_rich_menu_batch_request = rich_menu_batch_request;
...
pub async fn validate_rich_menu_object(configuration: &configuration::Configuration, rich_menu_request: models::RichMenuRequest) -> Result<(), Error<ValidateRichMenuObjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_rich_menu_request = rich_menu_request;
