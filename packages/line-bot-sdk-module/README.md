# Rust API client for line-bot-sdk-module
...
Put the package under your project folder in a directory named `line-bot-sdk-module` and add the following to `Cargo.toml` under `[dependencies]`:

```
line-bot-sdk-module = { path = "./line-bot-sdk-module" }
```
