...
pub async fn get_friends_demographics(configuration: &configuration::Configuration, ) -> Result<models::GetFriendsDemographicsResponse, Error<GetFriendsDemographicsError>> {
...
pub async fn get_message_event(configuration: &configuration::Configuration, request_id: &str) -> Result<models::GetMessageEventResponse, Error<GetMessageEventError>> {
...
pub async fn get_number_of_followers(configuration: &configuration::Configuration, date: Option<&str>) -> Result<models::GetNumberOfFollowersResponse, Error<GetNumberOfFollowersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_number_of_message_deliveries(configuration: &configuration::Configuration, date: &str) -> Result<models::GetNumberOfMessageDeliveriesResponse, Error<GetNumberOfMessageDeliveriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_date = date;

    let uri_str = format!("{}/v2/bot/insight/message/delivery", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_statistics_per_unit(configuration: &configuration::Configuration, custom_aggregation_unit: &str, from: &str, to: &str) -> Result<models::GetStatisticsPerUnitResponse, Error<GetStatisticsPerUnitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_custom_aggregation_unit = custom_aggregation_unit;
    let p_query_from = from;
    let p_query_to = to;

    let uri_str = format!("{}/v2/bot/insight/message/event/aggregation", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = req_builder.query(&[("customAggregationUnit", &p_query_custom_aggregation_unit.to_string())]);
