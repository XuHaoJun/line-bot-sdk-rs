# Rust API client for line-bot-sdk-module-attach
...
Put the package under your project folder in a directory named `line-bot-sdk-module-attach` and add the following to `Cargo.toml` under `[dependencies]`:
