...
pub async fn gets_all_valid_channel_access_token_key_ids(configuration: &configuration::Configuration, client_assertion_type: &str, client_assertion: &str) -> Result<models::ChannelAccessTokenKeyIdsResponse, Error<GetsAllValidChannelAccessTokenKeyIdsError>> {
    ...
    req_builder = req_builder.query(&[("client_assertion_type", &p_query_client_assertion_type.to_string())]);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetsAllValidChannelAccessTokenKeyIdsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Issue short-lived channel access token
pub async fn issue_channel_token(configuration: &configuration::Configuration, grant_type: &str, client_id: &str, client_secret: &str) -> Result<models::IssueShortLivedChannelAccessTokenResponse, Error<IssueChannelTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn issue_channel_token_by_jwt(configuration: &configuration::Configuration, grant_type: &str, client_assertion_type: &str, client_assertion: &str) -> Result<models::IssueChannelAccessTokenResponse, Error<IssueChannelTokenByJwtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_grant_type = grant_type;
    ...
    let mut multipart_form_params = std::collections::HashMap::new();
    multipart_form_params.insert("grant_type", p_form_grant_type.to_string());
    multipart_form_params.insert("client_assertion_type", p_form_client_assertion_type.to_string());
...
pub async fn issue_stateless_channel_token(configuration: &configuration::Configuration, grant_type: Option<&str>, client_assertion_type: Option<&str>, client_assertion: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>) -> Result<models::IssueStatelessChannelAccessTokenResponse, Error<IssueStatelessChannelTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_grant_type = grant_type;
    let p_form_client_assertion_type = client_assertion_type;
    let p_form_client_assertion = client_assertion;
...
pub async fn revoke_channel_token(configuration: &configuration::Configuration, access_token: &str) -> Result<(), Error<RevokeChannelTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn revoke_channel_token_by_jwt(configuration: &configuration::Configuration, client_id: &str, client_secret: &str, access_token: &str) -> Result<(), Error<RevokeChannelTokenByJwtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_client_id = client_id;
    let p_form_client_secret = client_secret;
    let p_form_access_token = access_token;
...
pub async fn verify_channel_token(configuration: &configuration::Configuration, access_token: &str) -> Result<models::VerifyChannelAccessTokenResponse, Error<VerifyChannelTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_access_token = access_token;
...
pub async fn verify_channel_token_by_jwt(configuration: &configuration::Configuration, access_token: &str) -> Result<models::VerifyChannelAccessTokenResponse, Error<VerifyChannelTokenByJwtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
