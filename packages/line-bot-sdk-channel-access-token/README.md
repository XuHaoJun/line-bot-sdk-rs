# Rust API client for line-bot-sdk-channel-access-token
...
Put the package under your project folder in a directory named `line-bot-sdk-channel-access-token` and add the following to `Cargo.toml` under `[dependencies]`:

```
line-bot-sdk-channel-access-token = { path = "./line-bot-sdk-channel-access-token" }
```
