# Rust API client for line-bot-sdk-manage-audience
...
Put the package under your project folder in a directory named `line-bot-sdk-manage-audience` and add the following to `Cargo.toml` under `[dependencies]`:

```
line-bot-sdk-manage-audience = { path = "./line-bot-sdk-manage-audience" }
```
