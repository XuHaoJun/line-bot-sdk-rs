# Rust API client for line-bot-sdk-liff
...
Put the package under your project folder in a directory named `line-bot-sdk-liff` and add the following to `Cargo.toml` under `[dependencies]`:
